...
class GrokLLMPipeline:
    """
    3-stage LLM response pipeline using Grok API: Maker → Checker → Judge
    Ensures grounded, traceable, and validated responses.
    """
    
    def __init__(self, api_key: str, similarity_threshold: float = 0.6,
                 input_cost_per_1m: float = 2.00, output_cost_per_1m: float = 6.00):
    ...
    def _maker_stage(
        ...
        """
        MAKER STAGE: Generate answer using Grok LLM.
...
Answer:"""
    ...
    def _checker_stage(
        ...
        """
        CHECKER STAGE: Validate answer using Grok.
    ...
    def _call_grok(self, prompt: str) -> str:
        ...
        Uses OpenAI client with Grok endpoint.
        """
        try:
